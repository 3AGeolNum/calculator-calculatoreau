...
bool link_bloc( const DynArray<Bloc*>& operator_array, DynArray<Bloc*>& operator_array_ordonated, const DynArray<Bloc*>& calcul_initial, int num_bloc1, int num_bloc2, bool if_precedent_edited ){
